...
function App() {
  ...
  useEffect(() => {
    alert("Please delete the post which seems uncomfortable to the user(You)")
  }, [])
    ...
    <div className="app">
          ...
          <form className="app__signup">
            <center>
              <img
                ...
                src={"https://freepngimg.com/download/logo/76861-web-instagram-script-typeface-typography-font.png"}
                alt={""}
              />
            </center>
            <Input
      ...
      <div className="app__posts">
        ...
        <div className="app__postsRight">
          ...
          <InstagramEmbed
            url='https://www.instagram.com/p/CIXojFDDxl6/'
            maxWidth={375}
            hideCaption={false}
